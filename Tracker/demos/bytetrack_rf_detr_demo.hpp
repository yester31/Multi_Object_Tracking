...
void bytetrack_rf_detr_demo() {
    ...
    std::filesystem::path save_file_path = save_dir_path / "bytetrack_rf_detr_demo.mp4" ;
	...
	while (true)
    {
        ...
        pre_proc_rf_detr(inputs, img, 0, INPUT_SIZE, INPUT_H, INPUT_W, mean, std);
