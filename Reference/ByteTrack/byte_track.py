...
def main():
    ...
    model = exp.get_model()
    test_size = exp.test_size # (800, 1440)
    ...
    if input_type == "video":
        ...
        while True:
            ...
            if ret_val:
                raw_img = frame.copy()
                img, _ = preproc(frame, test_size, (0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
        ...
        save_file_name = os.path.join(save_dir_path, f"{filename}_output.jpg")
