...
class yolo_opti_trt : public base_opti_trt
{
public:
    /**
     * @brief yolo model inference constructor
     * @details yolo_opti_trt class constructor and generate engine using ONNX or load engine file and inference.
