      ...
      
{
    ...
    std::cout << ("==================================================================") << std::endl;
    std::cout << ("      Starting the work to accelerate inference of the YOLO       ") << std::endl;
    std::cout << ("==================================================================") << std::endl;
...
void yolo_opti_trt::input_data(const void* inputs)
{
    // cpu -> gpu memory copy
...
// inference
void yolo_opti_trt::run_model()
{
    context->enqueueV3(stream);
}

// get output result
void yolo_opti_trt::output_data(void* outputs)
{
